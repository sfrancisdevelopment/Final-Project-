...
<h3>Fill out the following to edit student:</h3>
<div>
<form:form method="POST" action="/TestingProject/students/update" modelAttribute="student" class="form-horizontal">


	<div class="form-group">
    	<label class="control-label col-sm-2" for="s_id">Student ID:</label>
	    <div class="col-sm-10">
	      	<form:input type="text" id="s_id" path="s_id" readonly="true" />
	    </div>
  	</div>
